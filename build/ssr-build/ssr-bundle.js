...
var MemorialList_MemorialTile = function MemorialTile(props) {
   return Object(preact_min["h"])(
      'div',
      { 'class': 'card m-2 p-2', style: 'flex-wrap:wrap;' },
      Object(preact_min["h"])(
         'div',
         { 'class': 'card-body' },
         Object(preact_min["h"])('img', { 'class': 'img-responsive', src: props.avatar }),
         Object(preact_min["h"])(
            'p',
            { 'class': 'card-title col h5' },
            props.nm
         ),
         Object(preact_min["h"])(
            'button',
         ...
         props.items.map(function (item) {
            return Object(preact_min["h"])(ContentList_ContentCard, {
               ...
               showDeleteModal: function showDeleteModal(id) {
                  return props.showDeleteModal(id);
               },
               edited: item.edited
            });
         })
...
var ContentList_ContentCard = function ContentCard(props) {
   return Object(preact_min["h"])(
      ...
      Object(preact_min["h"])(
         ...
         Object(preact_min["h"])(
            'button',
            { 'class': 'btn btn-small btn-action tooltip float-right ml-2',
               'data-tooltip': 'delete',
               onClick: function onClick(id) {
                  return props.showDeleteModal(props.id);
               }
            },
            ' ',
            ContentList__ref3
...
// CONCATENATED MODULE: ./routes/ManageMemorial/DeleteModal.js


function DeleteModal__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function DeleteModal__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function DeleteModal__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var DeleteModal__ref = Object(preact_min["h"])(
   'div',
   { 'class': 'modal-title h5' },
   'Delete Item?'
);

var DeleteModal__ref2 = Object(preact_min["h"])(
   'div',
   { 'class': 'modal-body' },
   'Are you sure you want to delete this item? This action cannot be undone.'
);

var DeleteModal_DeleteModal = function (_Component) {
   DeleteModal__inherits(DeleteModal, _Component);

   function DeleteModal() {
      DeleteModal__classCallCheck(this, DeleteModal);

      return DeleteModal__possibleConstructorReturn(this, _Component.apply(this, arguments));
   }

   DeleteModal.prototype.render = function render(props) {
      var modalClasses = classnames_default()("modal", "modal-sm", { "active": props.showDeleteModal });

      return Object(preact_min["h"])(
         'div',
         { 'class': modalClasses },
         Object(preact_min["h"])('a', { onClick: props.hideDeleteModal,
            'class': 'modal-overlay',
            'aria-label': 'Close'
         }),
         Object(preact_min["h"])(
            ...
            Object(preact_min["h"])(
               ...
               Object(preact_min["h"])(
                  'button',
                  {
                     'class': 'btn btn-error',
                     onClick: function onClick(id) {
                        return props.delChronicle(props.item.id);
                     }
                  },
                  ' Delete Item'
               )
...
/* harmony default export */ var ManageMemorial_DeleteModal = (DeleteModal_DeleteModal);
   ...
   function ManageMemorial(props) {
      ...
      _this.delChronicle = function () {
         fetch(api + "!delChronicle", {
            ...
            var item = _this.state.items.find(function (item) {
               return item.id === _this.state.item.id;
            });
            console.log(item);
            var delAnimation = anime_min_default.a.timeline();
            delAnimation.add({
               ...
               complete: function complete() {
                  var items = _this.state.items.filter(function (i) {
                     return i !== item;
                  });
         ...
         contentColumn: Object(preact_min["h"])(
            ...
            this.state.active === "chronicle" && Object(preact_min["h"])(
               ...
               Object(preact_min["h"])(ManageMemorial_ContentList, {
                  ...
                  showDeleteModal: function showDeleteModal(id) {
                     return _this2.showDeleteModal(id);
                  }
               }),
               ...
               Object(preact_min["h"])(ManageMemorial_DeleteModal, {
                  item: this.state.item,
