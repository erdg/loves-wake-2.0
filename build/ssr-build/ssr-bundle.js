...
var Chronicle__ref = Object(preact_min["h"])('i', { 'class': 'icon icon-plus' });

var Chronicle__ref2 = Object(preact_min["h"])('i', { 'class': 'icon icon-arrow-left' });

var Chronicle__ref3 = Object(preact_min["h"])('i', { 'class': 'icon icon-arrow-right' });
...
var Chronicle_Chronicle = function (_Component) {
   ...
   function Chronicle() {
      ...
      return _ret = (_temp = (_this = Chronicle__possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
         ...
         _this.setState({ showModal: false, modalError: false });
      ...
      return Object(preact_min["h"])(components_GridContainer, {
         ...
         contentColumn: Object(preact_min["h"])(
            ...
            Object(preact_min["h"])(
               'button',
               {
                  'class': "circle btn btn-primary float-right tooltip tooltip-left " + style_default.a.AddSomething,
